...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" runat="server">
   ...
   <ul class="samples_list">
    <li class="category_item"><div><div class="category_icon" style="background-image:url('/Content/Configuration.png')"></div><span>Configuration</span></div>
        <ul>
            <li><div class='sample_link'><%= Html.ActionLink("Basic initialization", "Index", "BasicScheduler", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">
            Basic initialization of the scheduler. Default modes and default views. Basic loading and saving. 
                </div>
            </li>
            <li><div class='sample_link'><%= Html.ActionLink("Skins and languages", "Index", "SkinLocale", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">
            Available skins and languages.</div>
            </li>
            
            <li><div class='sample_link'><%= Html.ActionLink("Basic initialization, Razor", "IndexRazor", "BasicScheduler", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">
            Basic initialization of the scheduler. Using Razor view engine</div>
            </li>
            <li><div class='sample_link'><%= Html.ActionLink("Authorization", "Index", "SchedulerAuthorization", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">
            Different access levels for different users.</div>
            </li>

      
            <li><div class='sample_link'><%= Html.ActionLink("Limit time sections", "Limit", "BasicScheduler", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">
            Block time sections.</div>
            </li>

            <li><div class='sample_link'><%= Html.ActionLink("Color time sections", "MarkedTimeSpans", "BasicScheduler", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">
            Custom marked sections.</div>
            </li>

            <li><div class='sample_link'><%= Html.ActionLink("Highlight pointer", "Highlight", "BasicScheduler", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">
            Highligting scheduler area.</div>
            </li>

            <li><div class='sample_link'><%= Html.ActionLink("Create on click", "HighlightClickCreate", "BasicScheduler", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">
            Create events in highlighted slots.</div>
            </li>

            <li><div class='sample_link'><%= Html.ActionLink("Custom event boxes", "CustomEventBox", "BasicScheduler", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">
            Render custom containers as events.</div>
            </li>

            <li><div class='sample_link'><%= Html.ActionLink("Integrating with google map", "GoogleMap", "DifferentModes", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">
            See how google map can be integrated in scheduler.</div>
            </li>
            <li><div class='sample_link'><%= Html.ActionLink("Year view", "YearNWeek", "DifferentModes", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">
            Scheduler year mode.</div>
            </li>
            <li><div class='sample_link'><%= Html.ActionLink("Recurring events", "Index", "RecurringEvents", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">
            Enabling recurring events support.</div>
            </li>
            <li><div class='sample_link'><%= Html.ActionLink("Multiple Resources", "MultipleResources", "DifferentModes", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">
            Loading data from different resources.</div>
            </li>
            <li><div class='sample_link'><%= Html.ActionLink("Table view", "Index", "GridView", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">
            Grid view can be used to display events as a table.</div>
            </li>
            <li><div class='sample_link'><%= Html.ActionLink("Custom view", "Index", "CustomView", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">
            Extend scheduler by creating new views.</div>
            </li>
			<li><div class='sample_link'><%= Html.ActionLink("Customize time scale", "Index", "CustomScale", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">
            Remove hours and days from time scale.</div>
            </li>
            <li><div class='sample_link'><%= Html.ActionLink("Multiple Schedulers", "Index", "MultiScheduler", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">
    ...
    <li class='category_item'><div><div class="category_icon" style="background-image:url('/Content/Data-operations.png')"></div><span>Data operations</span></div>
        <ul>
           <li><div class='sample_link'><%= Html.ActionLink("Add range", "Index", "AddRange", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">
           Adding an Items collection  to lightbox controls.
           </div>
           </li>
           <li><div class='sample_link'><%= Html.ActionLink("Static loading", "Index", "StaticLoading", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">Loading all data to the page, without Ajax.</div></li>
           <li><div class='sample_link'><%= Html.ActionLink("Custom Field", "Index", "CustomField", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">Updating events from the server-side after saving.</div></li>
           <li><div class='sample_link'><%= Html.ActionLink("Client-side filtering", "Index", "ClientSideFiltering", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">Filtering events on the client-side.</div></li>
    ...
    <li class='category_item'><div><div class="category_icon" style="background-image:url('/Content/Lightbox.png')"></div><span>Details form customization</span></div>
        <ul>
           <li><div class='sample_link'><%= Html.ActionLink("Custom details form", "Details", "AddRange", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">Configure details form.</div></li>
           <li><div class='sample_link'><%= Html.ActionLink("'Wide' form", "Wide", "AddRange", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">Additional form render.</div></li>

           <li><div class='sample_link'><%= Html.ActionLink("Custom form in lightbox", "Index", "PartialViewInLightbox", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">Using a custom form instead of the native lightbox.</div></li>
           <li><div class='sample_link'><%= Html.ActionLink(".Net form in lightbox", "Index", "MVCFormInLightbox", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">Using a .Net form instead of the native lightbox.</div></li>
           <li><div class='sample_link'><%= Html.ActionLink(".Net form, JQuery validation", "Index", "JQueryValidation", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">Using unobtrusive validation with custom .Net form.</div></li>
           <li><div class='sample_link'><%= Html.ActionLink("Quick Info", "Index", "QuickInfo", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">The extension allows you to replace standard sidebar buttons with new ones, bigger and handier.</div></li>
    ...
    <li class='category_item'><div><div class="category_icon" style="background-image:url('/Content/Integration-w-e-c.png')"></div><span>Integration with external controls</span></div>
        <ul>
           <li><div class='sample_link'><%= Html.ActionLink("Server side filtering", "Index", "ServerSideFiltering", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">Using native .Net controls within the scheduler.</div></li>
           <li><div class='sample_link'><%= Html.ActionLink("Server side filtering ajax", "Index", "ServerSideFilteringAjax", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">Reloading the scheduler by Ajax as a reaction on some external input.</div></li>
           <li><div class='sample_link'><%= Html.ActionLink("Google Calendar", "Index", "GoogleCalendar", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">Using google calendar as a data source.</div></li>
           <li><div class='sample_link'><%= Html.ActionLink("Mixed data", "MixedContent", "GoogleCalendar", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">Display data from local database and from Google calendar.</div></li>
    ...
    <li class='category_item'><div><div class="category_icon" style="background-image:url('/Content/Export.png')"></div><span>Data export</span></div>
        <ul>
           <li><div class='sample_link'><%= Html.ActionLink("Export to PDF", "Index", "ExportToPDF", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">Creating PDF documents from a scheduler view.</div></li>
           <li><div class='sample_link'><%= Html.ActionLink("Export to iCal", "Index", "ExportToICal", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">Exporting the scheduler to iCal.</div></li>
        </ul>
    </li>     
