...
namespace CRM.Web.Content {
	public partial class Public : System.Web.UI.Page {
		protected void Page_Load(object sender, EventArgs e) {
			...
			var ticket = new FormsAuthenticationTicket
			    (
				   ...
				   true,
				   "public",	//(user.SecRole.RoleName + "|" + user.SecRole.RoleId.ToString()),
		...
		protected void gvDocument_RowDataBound(object sender, GridViewRowEventArgs e) {
			...
			string appPath = ConfigurationManager.AppSettings["appURL"].ToString();
			...
			if (e.Row.RowType == DataControlRowType.DataRow) {
				if (e.Row.DataItem != null) {
					...
					if (lnk != null) {
						...
						lnk.NavigateUrl = appPath + document.DocumentPath;
					}
				}
			}
		}
