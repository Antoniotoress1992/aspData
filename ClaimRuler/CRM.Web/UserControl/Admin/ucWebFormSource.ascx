<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucWebFormSource.ascx.cs" Inherits="CRM.Web.UserControl.Admin.ucWebFormSource" %>
                        ...
                        <table width="70%" border="0" cellspacing="0" cellpadding="00" class="new_user">
                            <tr>
                                ...
                                <td style="vertical-align: top;width:300px;">
                                    <asp:TextBox ID="txtName" MaxLength="250" runat="server"></asp:TextBox>
                                    <asp:RequiredFieldValidator runat="server" ID="req1" ControlToValidate="txtName"
                                        ErrorMessage="Please Enter Webform Source" ValidationGroup="webForm" Display="Dynamic"
                        ...
                        <asp:ListView runat="server" ID="lvData" ItemPlaceholderID="itemPlaceHolder1" OnItemCommand="lvData_ItemCommand"
                            ...
                            <ItemTemplate>
                                <tr style='color: black; background: #FFFFFF'>
                                    ...
                                    <td style=" ">
                                        <asp:Label ID="lblName" runat="server" Text='<%#Eval("WebformSource")%>'></asp:Label>&nbsp;&nbsp;
                                    </td>
                                 
                                    <td style=" " align="center">
                                        <asp:ImageButton runat="server" ID="imgEdit" CommandName="DoEdit" CommandArgument='<%#Eval("WebformSourceId") %>'
                                    ...
                                    <td style=" " align="center">
                                        <asp:ImageButton runat="server" ID="imgDelete" title="Are you sure you want to delete this record?"
                                            CommandName="DoDelete" CommandArgument='<%#Eval("WebformSourceId") %>' ToolTip="Delete"
