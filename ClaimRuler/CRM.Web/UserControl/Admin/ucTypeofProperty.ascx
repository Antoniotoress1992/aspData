<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucTypeofProperty.ascx.cs" Inherits="CRM.Web.UserControl.Admin.ucTypeofProperty" %>
                        ...
                        <table width="80%" border="0" cellspacing="0" cellpadding="00" class="new_user">
                            <tr>
                                ...
                                <td style="vertical-align: top;width:350px;" align="left"">
                                    &nbsp;<asp:TextBox ID="txtTypeofProperty" MaxLength="100" runat="server"></asp:TextBox>
                                    <asp:RequiredFieldValidator runat="server" ID="reqddlPrimaryProducer" ControlToValidate="txtTypeofProperty"
                                        ErrorMessage="Please Enter Type of Property" ValidationGroup="TypeofProperty" Display="Dynamic"
                                ...
                                <td align="left" style="vertical-align: top;width:300px;">
                                    <asp:Button ID="btnSave" Text="Save" runat="server" CssClass="mysubmit" OnClick="btnSave_Click"
                                        ValidationGroup="TypeofProperty" />
                                    &nbsp;
                        ...
                        <asp:ListView runat="server" ID="lvData" ItemPlaceholderID="itemPlaceHolder1" OnItemCommand="lvData_ItemCommand"
                            ...
                            <ItemTemplate>
                                <tr style='color: black; background: #FFFFFF'>
                                    ...
                                    <td style=" " align="center">
                                        <asp:ImageButton runat="server" ID="imgEdit" CommandName="DoEdit" CommandArgument='<%#Eval("TypeofPropertyId") %>'
                                    ...
                                    <td style=" " align="center">
                                        <asp:ImageButton runat="server" ID="imgDelete" title="Are you sure you want to delete this record?"
                                            CommandName="DoDelete" CommandArgument='<%#Eval("TypeofPropertyId") %>' ToolTip="Delete"
