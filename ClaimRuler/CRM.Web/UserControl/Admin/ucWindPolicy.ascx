<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucWindPolicy.ascx.cs" Inherits="CRM.Web.UserControl.Admin.ucWindPolicy" %>
                        ...
                        <table width="80%" border="0" cellspacing="0" cellpadding="00" class="new_user">
                            <tr>
                                ...
                                <td style="vertical-align: top;width:350px;" align="left"">
                                    &nbsp;<asp:TextBox ID="txtWindPolicy" MaxLength="100" runat="server"></asp:TextBox>
                                    <asp:RequiredFieldValidator runat="server" ID="reqddlPrimaryProducer" ControlToValidate="txtWindPolicy"
                                        ErrorMessage="Please Enter Wind Policy" ValidationGroup="WindPolicy" Display="Dynamic"
                            ...
                            <ItemTemplate>
                                <tr style='color: black; background: #FFFFFF'>
                                    ...
                                    <td style=" ">
                                        ...
                                        <asp:Label ID="lblWindPolicy" runat="server" Text='<%#Eval("WindPolicy")%>'></asp:Label>&nbsp;&nbsp;
                                    </td>
                                   
                                    <td style=" " align="center">
                                        <asp:ImageButton runat="server" ID="imgEdit" CommandName="DoEdit" CommandArgument='<%#Eval("WindPolicyId") %>'
                                    ...
                                    <td style=" " align="center">
                                        <asp:ImageButton runat="server" ID="imgDelete" title="Are you sure you want to delete this record?"
                                            CommandName="DoDelete" CommandArgument='<%#Eval("WindPolicyId") %>' ToolTip="Delete"
