<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucInspector.ascx.cs"
    Inherits="CRM.Web.UserControl.Admin.ucInspector" %>
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: top; width: 300px;">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" ID="req1" ControlToValidate="txtName"
                                        ErrorMessage="Please Enter Inspector Name" ValidationGroup="inspector" Display="Dynamic"
                        ...
                        <asp:ListView runat="server" ID="lvData" ItemPlaceholderID="itemPlaceHolder1" OnItemCommand="lvData_ItemCommand"
                            ...
                            <ItemTemplate>
                                <tr style='color: black; background: #FFFFFF'>
                                    ...
                                    <td style="">
                                        <asp:Label ID="lblName" runat="server" Text='<%#Eval("InspectorName")%>'></asp:Label>&nbsp;&nbsp;
                                    </td>
                                    <td style="" align="center">
                                        <asp:ImageButton runat="server" ID="imgEdit" CommandName="DoEdit" CommandArgument='<%#Eval("InspectorId") %>'
                                    ...
                                    <td style="" align="center">
                                        <asp:ImageButton runat="server" ID="imgDelete" title="Are you sure you want to delete this record?"
                                            CommandName="DoDelete" CommandArgument='<%#Eval("InspectorId") %>' ToolTip="Delete"
                                            ImageUrl="../../Images/delete_icon.png" Enabled='<%# (this.hfDeletePermission.Value == "0" || Convert.ToString(Eval("Status"))=="False") ? false : true %>'
