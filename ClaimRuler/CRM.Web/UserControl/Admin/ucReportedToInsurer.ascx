<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucReportedToInsurer.ascx.cs" Inherits="CRM.Web.UserControl.Admin.ucReportedToInsurer" %>
                ...
                <div class="warrape">
                        ...
                        <table width="80%" border="0" cellspacing="0" cellpadding="00" class="new_user">
                            <tr>
                                ...
                                <td style="vertical-align: top;width:350px;" align="left"">
                                    &nbsp;<asp:TextBox ID="txtReportedToInsurer" MaxLength="100" runat="server"></asp:TextBox>
                                    <asp:RequiredFieldValidator runat="server" ID="reqddlPrimaryProducer" ControlToValidate="txtReportedToInsurer"
                                        ErrorMessage="Please Enter Reported to Insurer" ValidationGroup="ReportedToInsurer" Display="Dynamic"
                                ...
                                <td align="left" style="vertical-align: top;width:300px;">
                                    <asp:Button ID="btnSave" Text="Save" runat="server" CssClass="mysubmit" OnClick="btnSave_Click"
                                        ValidationGroup="ReportedToInsurer" />
                                    &nbsp;
                    ...
                    <div class="vendor_list" id="dvData" runat="server">
                        <asp:ListView runat="server" ID="lvData" ItemPlaceholderID="itemPlaceHolder1" OnItemCommand="lvData_ItemCommand"
                            DataKeyNames="ReportedToInsurerId">
                            <LayoutTemplate>
                                <table width="100%" align='center' border="0" cellspacing="0" cellpadding="0" class="mytable hurr">
                                    <tr style="background: #c9dffb">
                                        ...
                                        <td width="70%" class='hl' style='text-align: center;'>
                                            <strong>Reported To Insurer</strong>
                                        </td>
                            ...
                            <ItemTemplate>
                                <tr style='color: black; background: #FFFFFF'>
                                    ...
                                    <td style=" ">
                                        ...
                                        <asp:Label ID="lblReportedToInsurer" runat="server" Text='<%#Eval("ReportedToInsurer")%>'></asp:Label>&nbsp;&nbsp;
                                    </td>
                                   
                                    <td style=" " align="center">
                                        <asp:ImageButton runat="server" ID="imgEdit" CommandName="DoEdit" CommandArgument='<%#Eval("ReportedToInsurerId") %>'
                                    ...
                                    <td style=" " align="center">
                                        <asp:ImageButton runat="server" ID="imgDelete" title="Are you sure you want to delete this record?"
                                            CommandName="DoDelete" CommandArgument='<%#Eval("ReportedToInsurerId") %>' ToolTip="Delete"
