...
function calcDueIn(reminder, now)
{
	...
	if(days > 1)
		...
		returnString += days + " " + ReminderDialogStrings[2]  + " ";
	if(hours > 1)
		returnString += hours + " " + ReminderDialogStrings[5]  + " ";
	else if(hours == 1)
		returnString += hours + " " + ReminderDialogStrings[4]  + " ";
	if(minutes > 1)
		returnString += minutes + " " + ReminderDialogStrings[7]  + " ";
	else if(minutes == 1)
		returnString += minutes + " " + ReminderDialogStrings[6]  + " ";
	if(overdue)
		returnString += ReminderDialogStrings[11];
	
	if(returnString == ReminderDialogStrings[11])
		returnString = ReminderDialogStrings[12];	
...
function setHeader(subject, datetime, location, img)
{
	...
	if(subject == null || subject == "")
		subject = ReminderDialogStrings[9];
	else
	...
	{
		document.getElementById("LocationLabel").innerHTML = ReminderDialogStrings[10] + " &nbsp";
...
{			
	...
	var units = string[1];
	var ticks = 0; 
	if(units.indexOf(ReminderDialogStrings[2],0) != -1)
		ticks = interval * 24 * 60 * 60 * 10000000;
	else if(units.indexOf(ReminderDialogStrings[4],0) != -1)
		ticks = interval * 60 * 60 * 10000000;
	else if(units.indexOf( ReminderDialogStrings[6],0) != -1)
