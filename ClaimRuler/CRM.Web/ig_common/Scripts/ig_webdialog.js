...
function igdlg_showDialog(contextDlg, height, width)  // context is the WebDialog control making the OBC
{
	...
	//I.I. bug fix for 97040 - tap and hold should open an appointment
	//window.open does not work in nested timeout statements under Safari
	var isiPad = navigator.userAgent.match(/iPad/i) != null; 
	if (isiPad)
	{
		contextDlg._openWindow();
	}
	else
	{
