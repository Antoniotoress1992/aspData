<%@ Page Title="" Language="C#" MasterPageFile="~/Protected/ClaimRulerClaim.master" AutoEventWireup="true"
    CodeBehind="LeadInvoice.aspx.cs" Inherits="CRM.Web.Protected.LeadInvoice" %>
            ...
            <table style="width: 80%; border-collapse: separate; border-spacing: 2px; padding: 3px; margin: auto;" border="0" class="editForm no_min_width">
                ...
                <tr>
                    <td colspan="3">
                        ...
                        <asp:GridView ID="gvInvoiceLines" ShowFooter="true" Width="100%" ShowHeaderWhenEmpty="true" CssClass="gridView" HorizontalAlign="Center"
                            runat="server" DataKeyNames="InvoiceLineID" OnRowCommand="gvInvoiceLines_RowCommand"
                            OnRowDataBound="gvInvoiceLines_OnRowDataBound" AutoGenerateColumns="False" CellPadding="2"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Date">
                                    ...
                                    <FooterTemplate>
                                        ...
                                        <ig:WebDatePicker ID="txtDate" runat="server" StyleSetName="Default" Width="80px" CssClass="date_picker" TabIndex="15" Buttons-CustomButton-ImageUrl="~/Images/ig_calendar.gif" />
                                    </FooterTemplate>
                                    ...
                                    <FooterTemplate>
                                        ...
                                        <div>
                                            <asp:DropDownList ID="cbxServiceDescription" runat="server" AutoCompleteMode="Suggest"
                                                Width="400px" AutoPostBack="true" OnSelectedIndexChanged="cbxServiceDescription_selectedIndexChanged" TabIndex="16" />
                                        </div>
                                        <div style="margin-top: 3px;">
                                            <ig:WebTextEditor ID="txtComments" runat="server" Width="90%" TabIndex="17"/>
                                        </div>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Quantity" ItemStyle-HorizontalAlign="Right">
                                    ...
                                    <FooterTemplate>
                                        ...
                                        <ig:WebNumericEditor ID="txtQty" runat="server" Width="100px" MaxLength="10" OnTextChanged="txtQty_TextChanged"
                                            DataMode="Decimal" AutoPostBackFlags-ValueChanged="On" TabIndex="18" />
                                    </FooterTemplate>
                                ...
                                <asp:TemplateField HeaderText="Rate" ItemStyle-HorizontalAlign="Right">
                                    ...
                                    <FooterTemplate>
                                        ...
                                        <ig:WebNumericEditor ID="txtRate" runat="server" Width="100px" MaxLength="10" AutoPostBack="true"
                                            OnTextChanged="txtRate_TextChanged" DataMode="Decimal" TabIndex="19" />
                                ...
                                <asp:TemplateField HeaderText="Total" ItemStyle-HorizontalAlign="Right">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtLineAmount" runat="server" Text='<%# Eval("LineAmount", "{0:N2}") %>'
                                            BorderStyle="None" Style="text-align: right; background-color: inherit;" Width="100px" TabIndex="20" />
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <div>
                                            &nbsp;
                                        ...
                                        <asp:TextBox ID="txtLineAmount" runat="server" Width="100px"
                                            BorderStyle="None" Style="text-align: right; background-color: inherit;"  TabIndex="21"/>
                                    </FooterTemplate>
                                ...
                                <asp:TemplateField HeaderText="Billable" ItemStyle-HorizontalAlign="Center">
                                    ...
                                    <FooterTemplate>
                                        ...
                                        <asp:CheckBox ID="cbxBillable" runat="server"  TabIndex="22"/>
                                    </FooterTemplate>
                                    ...
                                    <ItemTemplate>
                                        <asp:Panel ID="pnlCommands" runat="server" Visible='<%# Convert.ToInt32(Eval("InvoiceLineID")) > 0 %>'>
                                            <asp:ImageButton ID="btnEdit" runat="server"
                                                ...
                                                ToolTip="Edit"
                                                ImageUrl="~/Images/edit.png" TabIndex="23"></asp:ImageButton>

                                            <asp:ImageButton ID="btnDelete" runat="server"
                                                CommandName="DoDelete"
                                                OnClientClick="javascript:return confirm('Are you sure you want to delete this line?');"
                                                CommandArgument='<%#Eval("InvoiceLineID") %>'
                                                ToolTip="Delete"
                                                ImageUrl="~/Images/delete_icon.png" TabIndex="24"></asp:ImageButton>
                                        </asp:Panel>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <div>
