<%@ Page Title="" Language="C#" MasterPageFile="~/Protected/ClaimRulerClaim.master" AutoEventWireup="true" CodeBehind="LeadsImagesUploadPopUp.aspx.cs" Inherits="CRM.Web.Protected.LeadsImagesUploadPopUp" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMiddArea" runat="server">
	...
	<script type="text/javascript">
	    ...
	    $(document).ready(function () {
	       // $("#navBar").hide();
	        // $(".igspl_Office2007BlueVSplitBarWidth").hide();
	        $(".toolbar.toolbar-body").hide();
	        $(".ig_Control.igdm_ControlHorizontal").hide();
	        $(".search_box").hide();
	        $("#logo").hide();
	        $(".paneContentInner.nowrap.middle.center").hide();
	        $(".newone").hide();

	        
	        $("#WebSplitter1 table td:first").hide();
	        $(".igspl_Office2007BlueVSplitBar").hide();
	        $("#WebSplitter1").css("width", "99.9%");
	        $(".igspl_Office2007BluePane").css("overflow", "hidden");
	    });
