<%@ Page Title="" Language="C#" MasterPageFile="~/Protected/ClaimRuler.Master" AutoEventWireup="true" CodeBehind="Activities.aspx.cs" Inherits="CRM.Web.Protected.Activities" %>
...
<%@ Register Src="~/UserControl/ucActivities.ascx" TagName="ucActivities" TagPrefix="uc1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMiddArea" runat="server">
    ...
    <div class="toolbar toolbar-body">
        <table>
            <tr>
                <%--<td>
                    <asp:LinkButton ID="btnNewTask" runat="server" CssClass="toolbar-item"                        
                        PostBackUrl="~/protected/TaskEdit.aspx" CausesValidation="false">
					        <span class="toolbar-img-and-text" style="background-image: url(../images/tasks.png)">New Task</span>
                    </asp:LinkButton>
                </td>--%>
               <%-- <td>
                    <asp:LinkButton ID="btnNewEvent" runat="server" CssClass="toolbar-item"
                        Visible='<%# CRM.Core.PermissionHelper.checkEditPermission("Tasks.aspx") %>'
                        PostBackUrl="~/protected/EventEdit.aspx" CausesValidation="false">
            ...
            <tr>
                ...
                <td <%--class="top left" style="width: 50%"--%>>
                    ...
                    <asp:Panel ID="pnlDayView" runat="server">
                        <igsch:WebDayView ID="WebDayView1" Visible="false" runat="server" WebScheduleInfoID="WebScheduleInfo1"
                            Width="100%"
                            VisibleDays="1"
    ...
    <asp:EntityDataSource ID="edsTasks" runat="server" ConnectionString="name=CRMEntities" DefaultContainerName="CRMEntities"
        ...
        Where="it.ClientId = @ClientID && it.UserID = @UserID && it.Activity = 1 && it.TaskStatusID != 2 && it.TaskStatusID != 3"
        OrderBy="it.DateDue Desc"
